...
<body>
    ...
    <nav>
        <div class="container nav_container">
              <div class="logo">
                    <a href="<?php echo ROOT_URL?>index.php" class="nav_logo"><i class="fa-solid fa-k icon"></i>alyan's<i class="fa-solid fa-i icon"></i>nsights <i class="fa-solid fa-brain icon"></i></a>
              </div>
              <ul class="nav_items">
